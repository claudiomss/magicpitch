  ...
  return (
    <>
      <main className="px-4 mobileL:px-6 lg:px-9 mt-8 md:mt-28 lg:mt-36">
        <Image
          className="m-auto w-[75vw] sm:w-[82vw]"
          src={screenweb}
          alt="screenweb"
        />
        <section
          ...
          lg:mt-[-28rem] lg:h-[28rem] lg:pt-36"
        >
...
const Card = ({ icon, color, percentage, title }) => {
  return (
    <main className="grid gap-2  place-items-center bg-[#F7F5FE]   p-12 md:p-8 lg:p-12 rounded-2xl odd:translate-y-10">
      <Image
        ...
        alt="icon"
      />
      <p className="text-lg md:text-xl lg:text-2xl font-bold">{percentage}</p>
      <p className="text-sm md:text-base lg:text-lg text-[#474646] text-center">
        {title}
      </p>
    </main>
  )
