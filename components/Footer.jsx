...
export function Footer() {
  // return (
  //   <main className=" grid-cols-7 px-20 py-16">
  ...
  return (
    <main className=" grid-cols-7 px-20 py-16 text-center">
      <section className="col-span-3">
        ...
        <p className="mt-16 text-[15px] text-[#353434]">
          One Central, The Offices 4 Dubai, United Arab Emirates
        </p>
        <p className="mt-2 mb-16 text-[15px] text-[#353434]">
          info@magicpitch.ai
        </p>
      </section>
      ...
      <section className="text-[14px] my-4 font-semibold text-[#353434]">
        Solution
      </section>
      <section className="flex  flex-col gap-4 text-[14px] text-[#353434]">
      ...
      <section className="flex my-4 flex-col gap-4 text-[14px] text-[#353434]">
